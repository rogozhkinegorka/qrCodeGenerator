...
public class QRGEncoder2 {
    ...
    public QRGEncoder2(String data, String type) {
        encoded = encodeContents(data, null, QRGContents.Type.TEXT);
    }

    public QRGEncoder2(String data, String type, int dimension) {
        this.dimension = dimension;
        encoded = encodeContents(data, null, QRGContents.Type.TEXT);
    }

    public QRGEncoder2(String data, Bundle bundle, String type, int dimension) {
        this.dimension = dimension;
